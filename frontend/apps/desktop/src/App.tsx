                    ...
                    <>
                        ...
                        <div className="ml-24 flex-1 overflow-y-auto p-5 ">
                            <Routes>
                                ...
                                <Route path="/events/add" element={<AddEvent setUserAuthenticated={setUserAuthenticated}/>} />
                                <Route path="/events" element={<Events setUserAuthenticated={setUserAuthenticated}/>} />
