    ...
    <div className="h-full bg-white p-8 overflow-y-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col space-y-4 mt-4">
          <button className="w-40 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
            Save Changes
          </button>
          <div className="flex space-x-4 mt-4">
            <button className="w-40 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
              Logout
            </button>
            <button className="w-40 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
              Delete Account
